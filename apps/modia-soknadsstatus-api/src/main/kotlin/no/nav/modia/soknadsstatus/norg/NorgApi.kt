...
interface NorgApi : Pingable {
    companion object {
        @JvmStatic
        val IKKE_NEDLAGT: List<NorgDomain.EnhetStatus> = NorgDomain.EnhetStatus.values().asList().minus(NorgDomain.EnhetStatus.NEDLAGT)
    }
...
class NorgApiImpl(
    ...
    companion object {
        internal fun toInternalDomain(kontor: RsNavKontorDTO) = NorgDomain.EnhetGeografiskTilknyttning(
