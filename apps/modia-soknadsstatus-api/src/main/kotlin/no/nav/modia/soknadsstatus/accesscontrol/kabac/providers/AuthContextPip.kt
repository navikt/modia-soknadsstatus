...
class AuthContextPip(private val authContext: AuthenticationContext) : Kabac.PolicyInformationPoint<Security.SubjectPrincipal> {
    ...
    override fun provide(ctx: Kabac.EvaluationContext): Security.SubjectPrincipal {
        return requireNotNull(authContext.principal()) {
            "Principal was null"
        }
    }
}
