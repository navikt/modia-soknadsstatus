...
fun main() {
    ...
    System.setProperty("KAFKA_SOURCE_BEHANDLING_TOPIC", "modia-soknadsstatus-behandling")
    System.setProperty("KAFKA_BROKERS", "localhost:9092")
    System.setProperty("KAFKA_DEAD_LETTER_QUEUE_TOPIC", "modia-soknadsstatus-dlq")
    System.setProperty("KAFKA_DEAD_LETTER_QUEUE_BEHANDLING_TOPIC", "modia-soknadsstatus-behandling-dlq")
