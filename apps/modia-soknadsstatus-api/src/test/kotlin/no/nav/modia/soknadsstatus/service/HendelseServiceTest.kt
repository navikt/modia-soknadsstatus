...
class HendelseServiceTest : TestUtilsWithDataSource() {
    ...
    @Test
    fun `opprette behandling og hendelse`() =
        runBlocking {
            val opprettHendelse =
                InnkommendeHendelse(
    ...
    @Test
    fun `opprette behandling og hendelse roll back`() =
        runBlocking {
            ...
            coEvery { pdlOppslagService.hentAktiveIdenter("mock-token", "19099531196") } returns
                listOf(
                    "19099531196",
                    "26127338824",
                )
