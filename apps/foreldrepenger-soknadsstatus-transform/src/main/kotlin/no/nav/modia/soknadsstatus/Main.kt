...
fun transform(key: String?, value: String): soknadsstatusDomain.soknadsstatusOppdatering {
    ...
    return soknadsstatusDomain.soknadsstatusOppdatering(
        ...
        status = enumValueOf<soknadsstatusDomain.Status>(decodedMessage.avslutningsstatus.value) ?: soknadsstatusDomain.Status.UNDER_BEHANDLING,
