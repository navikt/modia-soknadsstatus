package no.nav.modia.soknadstatus.jms
...
class UserCredentialsConnectionFactoryAdapter(
    ...
    override fun createConnection(userName: String?, password: String?): Connection = doCreateConnection()

    override fun createContext(): JMSContext = connectionFactory.createContext()

    override fun createContext(userName: String?, password: String?): JMSContext = connectionFactory.createContext(username, password)

    override fun createContext(userName: String?, password: String?, sessionMode: Int): JMSContext = connectionFactory.createContext(userName, password, sessionMode)
    ...
    override fun createTopicConnection(userName: String?, password: String?): TopicConnection = doCreateTopicConnection()

    override fun createQueueConnection(): QueueConnection = doCreateQueueConnection()

    override fun createQueueConnection(userName: String?, password: String?): QueueConnection = doCreateQueueConnection()
